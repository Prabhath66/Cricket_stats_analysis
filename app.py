...
3. **Explore Stats:** You can view a player's **Batting Stats** or **Bowling Stats**.
...
This dashboard was created by [Prabhath], a cricket enthusiast and data analyst, to provide an interactive way to explore and compare player stats. Happy exploring and analyzing!
